...
const NewsSection = () => {
  return (
    <section
      id="news"
      className="pt-32 pb-36 relative after:absolute after:w-full after:h-3/4 after:top-0 after:left-0 after:bg-[#EEF4F8] z-0 after:-z-[1]"
    >
      <div className="container">
        <div className="text-center mb-12">
          <span className="text-light-gray text-2xl block mb-1">News</span>
          <h2 className="text-4xl text-dark-navy relative inline-block">
            <SideShapeHeading headingClassName="font-medium">

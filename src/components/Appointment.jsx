...
const Appointment = () => {
        ...
        <div className=" bg-black bg-opacity-60">
          <div className="container relative py-16 grid grid-cols-10 gap-12 max-lg:items-start max-lg:flex max-lg:flex-col max-lg items-center">
            <div className="col-span-6">
              <h2 className="text-[44px] max-xl:text-4xl max-lg:text-3xl max-sm:text-2xl font-medium leading-snug mb-7 max-sm:mb-5 text-white">
                “Building Bridges: Embracing, Strengthening Communities”
              </h2>
              <p className="text-2xl max-xl:text-xl max-lg:text-lg max-sm:text-sm mb-7 max-sm:mb-5 text-white">
                - Celebrating excellence, Building Connections...
              </p>
              <p className="text-2xl max-xl:text-xl max-lg:text-lg max-sm:text-sm text-white">
 ...
 p-6 absolute -bottom-7 max-xl:-bottom-10 right-0 max-lg:static"
            >
              <h3 className="text-[17px] max- font-semibold text-red-600 mb-5">
              ...
              <ul className="text-lg max-xl:text-base flex flex-col gap-[2px]">
                <li>Monday: Closed</li>

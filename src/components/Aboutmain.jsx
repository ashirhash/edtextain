      ...
      <div className="container flex flex-col gap-5 md:flex-row bg-white">
        <div className="md:w-1/2 relative flex flex-col items-center md:items-start">
          <img
            ...
            className="rounded-lg shadow-lg max-lg:max-w-full max-lg:w-full max-md:max-w-[400px] max-lg:mr-auto relative z-[1] object-cover w-4/5 ml-auto"
          />
          <img
            src={red_dots}
            className="absolute left-16 -bottom-3 max-sm:-bottom-5 max-sm:left-2 max-sm:w-16 max-2xl:w-24"
            alt="red_dots"
          />
        ...
        <div className="md:w-1/2 mt-8 md:mt-0">
          ...
          <h2 className="text-[44px] max-lg:text-3xl max-2xl:text-4xl font-medium text-dark-navy mb-5 leading-snug">
          ...
          <div className="lg:w-4/5">
            ...
            <p className="text-light-gray text-base font-semibold mb-7">
